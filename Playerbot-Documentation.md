...
``aaoe`` | automatically avoid the majority of harmful aoe spells
``smana`` | healers save mana by prioritizing high-efficiency spells when mana falls below a threshold
